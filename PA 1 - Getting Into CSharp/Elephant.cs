...
namespace PA_1___Getting_Into_CSharp
{
    public class Elephant : Animal
    {
         ...
         * parent class Animal equal to the Elephant information found from the user.
        ...
        /* Type: public override void 
         * 
         * Purpose: If the user wishes to hear the Elephant's noise, this
        ...
        /* Type: public override void
         * 
         * Purpose: Allows the user to increment the Elephant's age by
